...
my feet fly first + heart goes boom（人多鬆手衝掉／走散）
...
owl、timer、contest（read-it-right）；store、phone、touch（eyes-not-hands）；elevator、inside、fly（hold-and-wait）。（listen-and-go 零新字）
