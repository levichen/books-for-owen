# -*- coding: utf-8 -*-
"""Book 1: I Can Save My Answer! — 上課搶答（已出版）。內容自 render_pdf.py 原樣搬移。"""
from parts import *
...
BOOK = {
    "slug": "save-my-answer",
    "order": 1,
    "title_pre": "I Can ", "title_hi": "Save", "title_post": " My Answer!",
    "title_zh": "把答案存起來",
    "subtitle": "Owen's superpower story",
    "tagline_zh": "Owen 的超能力故事",
    "chips": ["Social Story", "English", "12 pages"],
    ...
    "cue_html": ("口訣（全書通關密語）：<b>Hand up &rarr; Wait &rarr; Save it!</b>&nbsp;"
                 "當他哪天主動說出 &ldquo;My mouth feels itchy&rdquo;（我察覺到衝動了），"
                 "就是最值得大力稱讚的時刻。"),
    "cover": scene_cover,
}
